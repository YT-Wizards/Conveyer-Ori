...
export const ALL_GROUPS: Group[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "PEXELS_MAX_PAUSE_MIN", label: "Pexels: max wait when rate-limited (min)", desc: "When all your Pexels keys hit the hourly limit, wait at most this many minutes then retry (and keep retrying until the limit resets). Lower = retries sooner.", examples: "15 default" },
