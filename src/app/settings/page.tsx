...
import { ALL_GROUPS } from "./_groups";
  ...
  return (
    <div>
      ...
      <p className="muted" style={{ marginBottom: 20, fontSize: 14 }}>
        All configuration for the pipeline — required keys, voice, footage and assembly options.
      </p>
      ...
      <div className="card" style={{ marginBottom: 14 }}>
        <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 6 }}>
          <h2 style={{ margin: 0 }}>Google Drive Backup</h2>
          <span className="badge badge-accent">OPTIONAL</span>
        </div>
        <p className="muted" style={{ fontSize: 13, marginBottom: 16, lineHeight: 1.55 }}>
          Auto-upload finished runs to your Google Drive so your work is never lost. The final video
          goes to a <code>Final Videos</code> folder; each run&apos;s source clips + photos plus a
          metadata file go into <code>Runs/&lt;your run name&gt;/</code>. Your local copies are kept too.
        </p>
        ...
        >
          ...
          <span className="faint" style={{ fontSize: 11 }}>
            Uploads final video + per-scene clips + metadata after each run. Saves with <strong>Save all changes</strong>.
          </span>
        </div>
        ...
        <div style={{ display: "grid", gap: 16 }}>
          {[
            ...
            },
            {
              ...
              desc: "Drive folder ID for finished videos. Leave empty to auto-create `Conveyer/Final Videos/` on first sync.",
              examples: "From folder URL: drive.google.com/drive/folders/<THIS_PART>",
            },
            {
              key: "GDRIVE_RUNS_FOLDER_ID",
              desc: "Drive folder ID for per-run sub-folders with source clips + metadata. Leave empty to auto-create `Conveyer/Runs/`.",
